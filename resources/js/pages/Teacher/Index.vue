...
async function selectCourse(course: Course): Promise<void> {
    ...
    try {
        const response = await fetch(
            `/api/teacher/courses/${course.id}/students`,
            {
                headers: {
                    Authorization: `Bearer ${token}`,
                    Accept: 'application/json',
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="grid gap-4 pt-3 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <CardContent>
                            <p class="text-sm">
                                {{ course.active_students_count }} estudiantes
                                matriculados
                            </p>
                        </CardContent>
                    </Card>
            ...
            <Card v-if="selectedCourse">
                <CardHeader>
                    ...
                    <CardDescription>
                        Selecciona un estudiante para registrar su informe de
                        avance.
                    </CardDescription>
                </CardHeader>
                        ...
                        <TableBody>
                            ...
                            >
                                ...
                                <TableCell>
                                    <Badge
                                        :variant="
                                            levelBadge(report.achievement_level)
                                        "
                                    >
