  ...
  <AppLayout>
    <div class="space-y-6">
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-bold tracking-tight">Portal de Padres</h1>
      ...
      >
        No tienes estudiantes registrados. Si completaste una admisión, espera
        la aprobación.
      </div>
        ...
        <CardContent class="flex items-start gap-3 py-4">
          ...
          <div>
            ...
            <p class="text-muted-foreground text-sm">
              Tienes {{ dueSoonTuitions.length }} obligación(es) con fecha
              límite cercana.
            </p>
            <Button
              variant="link"
          ...
          <div class="flex items-start justify-between">
            <div>
              ...
              <CardDescription>
                ...
                {{ selectedStudent.course_name ?? 'Sin curso asignado' }}
              </CardDescription>
            </div>
      ...
      <div v-if="students.length > 1 && !loading">
        ...
        <div class="grid gap-4 pt-3 sm:grid-cols-2">
          <Card
            ...
            :class="{
              'ring-primary ring-2': student.id === selectedStudent?.id,
            }"
          ...
          >
            <CardHeader>
              <div class="flex items-start justify-between">
                <div>
                  <CardTitle
                    >{{ student.first_name }} {{ student.last_name }}</CardTitle
                  >
                  <CardDescription>
                    Nivel de interés:
                    {{ student.admission?.level?.name ?? 'Por definir' }}
                  </CardDescription>
                </div>
