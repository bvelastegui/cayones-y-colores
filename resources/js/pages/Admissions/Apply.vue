...
const benefits = [
  ...
  },
  {
    ...
    description: 'Nuestro equipo te orientará durante cada etapa del proceso.',
  },
  {
    icon: ShieldCheck,
    title: 'Información segura',
    description: 'Tus datos se utilizan únicamente para gestionar la admisión.',
  },
];
      ...
      >
        <aside class="flex flex-col gap-9 lg:sticky lg:top-28 lg:self-start">
          <div class="flex flex-col gap-5">
            ...
            <p class="text-muted-foreground text-lg leading-8">
              Cuéntanos sobre tu familia. Revisaremos la solicitud y te
              contactaremos para acompañarte en los siguientes pasos.
            </p>
          </div>
          ...
          <div class="bg-sun/20 rounded-3xl p-6">
            <strong class="font-heading text-lg">¿Necesitas ayuda?</strong>
            <p class="text-muted-foreground mt-2 text-sm leading-6">
              Nuestro equipo de admisiones está listo para orientarte.
            </p>
            <address class="mt-4 flex flex-col gap-3 text-sm not-italic">
              <a
        ...
        <Card class="border-border/70 shadow-primary/5 shadow-xl">
          <template v-if="submitted">
            <CardHeader class="items-center gap-5 pt-10 text-center">
              <span
              ...
              >
                ...
                <CardDescription class="text-base leading-7">
                  Gracias por confiar en Crayones y Colores. Revisaremos la
            ...
            <CardContent>
              <div class="bg-muted rounded-3xl p-6 text-center">
                ...
                <p class="text-muted-foreground mt-2 text-sm leading-6">
                  Nuestro equipo validará la disponibilidad del nivel solicitado
                  y se comunicará usando los datos registrados.
                </p>
              </div>
            </CardContent>
            ...
            <CardHeader class="gap-4">
              ...
              <div class="flex flex-col gap-2">
                ...
                <CardDescription class="text-base leading-6">
                  Todos los campos son necesarios para iniciar el proceso.
                </CardDescription>
              </div>
            </CardHeader>
            ...
            >
              <CardContent>
                <div class="flex flex-col gap-8">
                  <FieldSet>
                    <FieldLegend>Sobre el aspirante</FieldLegend>
                    <FieldDescription>
                      Información del niño o niña que desea ingresar.
                    </FieldDescription>
                    <FieldGroup class="grid gap-5 sm:grid-cols-2">
                      <Field
                        class="sm:col-span-2"
                        :data-invalid="Boolean(error) && !levelId"
                      >
                        ...
                        >
                          <SelectTrigger
                            ...
                            :aria-invalid="Boolean(error) && !levelId"
                          >
                            <SelectValue
                              :placeholder="
                                levelsLoading
                        ...
                        <FieldError
                          ...
                          :errors="[levelsError]"
                        />
                        <FieldDescription v-else-if="noLevelsAvailable">
                          En este momento no hay niveles habilitados para
                          admisión.
                        </FieldDescription>
                        <Button
                          v-if="levelsError"
                      ...
                      <Field>
                        <FieldLabel for="first_name"> Nombres </FieldLabel>
                        <Input
                          id="first_name"
                          v-model="firstName"
                          name="first_name"
                      ...
                      <Field>
                        <FieldLabel for="last_name"> Apellidos </FieldLabel>
                        <Input
                          id="last_name"
                          v-model="lastName"
                          name="last_name"
                  ...
                  <FieldSet>
                    <FieldLegend>Datos del representante</FieldLegend>
                    <FieldDescription>
                      Usaremos estos medios para contactarte.
                    </FieldDescription>
                    <FieldGroup class="grid gap-5 sm:grid-cols-2">
                      <Field class="sm:col-span-2">
