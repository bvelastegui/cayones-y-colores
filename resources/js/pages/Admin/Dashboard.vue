    ...
    <AppLayout>
        <div class="space-y-6">
            <div class="flex items-start justify-between">
                ...
                <Button :disabled="generating" @click="generateTuitions">
                    <Spinner v-if="generating" data-icon="inline-start" />
                    <Bell v-else class="size-4" data-icon="inline-start" />
                    {{
                        generating
                            ? 'Generando...'
                            : 'Generar pensiones del mes'
                    }}
                </Button>
            </div>
            ...
            >
                ...
                <Card>
                    <CardHeader class="pb-2">
                        <CardDescription
                            >Estudiantes matriculados</CardDescription
                        >
                        <CardTitle class="text-3xl">{{
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Reglas institucionales de asignación de personal y
                        cupos.
                    </CardDescription>
                </CardHeader>
